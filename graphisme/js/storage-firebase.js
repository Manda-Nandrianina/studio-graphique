...
const Storage = {
    ...
    initDefaultUsers: async function() {
        try {
            const users = [
                { id: 'user_Manda_Nandrianina', username: 'Manda Nandrianina', password: 'MiavakaMiel@15042024', role: 'Manda Nandrianina', name: 'Manda Nandrianina' },
                { id: 'user_papou', username: 'papou', password: 'papou123', role: 'user', name: 'Papou' }
            ];
